...
def evaluate3D(modelName):
    ...
    path_GT = './Results/DataSet_Challenge/GT_Nifti/Val_1'
    ...
    for s_i in range(len(Pred_names)):
        ...
        for c_i in range(numClasses):
            ...
            """
            modify /home/ytl0623/data/anaconda3/envs/spleen/lib/python3.9/site-packages/medpy/metric/
                   binary.py: umpy.bool -> umpy.bool_
            """
